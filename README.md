...
To create the bin file to be uploaded as filesystem without the module connected via USB go to the menu Tools/ESP8266 LittleFS data upload Some error are going to be split out on the monitor, that is perfectly normal browse up in the monitor window to find a line looking like that:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3Nzc0MDI1OF19
-->